QT += core quick network quickcontrols2 svg gui widgets
CONFIG += c++11
...
SOURCES += \
    ...
    vigem/vigemhintwidget.cpp \
    vigem/vigemkeymapper.cpp \
    vigem/vigemwidget.cpp \
    wm.cpp
...
QMAKE_TARGET_COMPANY = QtQuick4D
QMAKE_TARGET_DESCRIPTION = PartyZone Game Streaming Client
QMAKE_TARGET_PRODUCT = PartyZone
